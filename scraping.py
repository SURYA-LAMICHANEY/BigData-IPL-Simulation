...
for u_link in range(1, 14):
    my_off_url = '/home/surya/Desktop/OnlineClass/ThirdSemester/MDSC-302-Big Data Analytics/Practical/miniProject/Step-1/NewPages/Batsmen/' + str(u_link) + '.html'
    scraper(my_off_url, filename, bat_arr)
writer(filename, bat_arr)

filename = 'bowling.csv'
for u_link in range(1, 14):
    my_off_url = '/home/surya/Desktop/OnlineClass/ThirdSemester/MDSC-302-Big Data Analytics/Practical/miniProject/Step-1/NewPages/Bowlers/' + str(u_link) + '.html'
